...
# the name of the bootstrap bucket 
#this is where we copy th bootstrapped installer for downloading
variable "bootstrap_bucket" {}

# the name of the bootstrap file, this shouldn't really need to be
# overridden
